                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                                ...
                                Notificaciones
                                    ...
                                    $sql=$pdo->query("SELECT id_oferta, ID_PEDIDO, nombre_pers, apellido, direccion_ped, descripcion_ped,  monto_oferta, duracion_oferta, nombre_empresa, situacion_oferta, fecha_inicio
                                    FROM oferta_pedido, persona, pedido, empresa, cliente
                                   WHERE rela_persona=id_persona and rela_cliente=id_cliente and rela_pedido=id_pedido
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <table id="Asignarcadete" class="table table-bordered"  width="100%" cellspacing="0">
                  <thead>
                    <tr>
                    <th>NRO</th>
                      <th>CLIENTE</th>
                ...
                include ("conexion.php");
                //SELECCIONAMOS LO DE SE VA A IMPRIMIR
                $sql=$pdo->query("SELECT id_oferta, ID_PEDIDO, nombre_pers, apellido, direccion_ped, descripcion_ped,  monto_oferta, duracion_oferta, nombre_empresa, situacion_oferta
                FROM oferta_pedido, persona, pedido, empresa, cliente
               WHERE rela_persona=id_persona and rela_cliente=id_cliente and rela_pedido=id_pedido
               and  rela_empresa=id_empresa and situacion_oferta='Aceptado' and id_empresa= '".$id_empresa."'  ")->fetchAll(PDO::FETCH_CLASS) 
                ?> 
                ...
                <div class="modal fade" id="modalCRUD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form id="formPersonas" action="../../controlador/insert/asignar_cadete.php" method="post">    
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                    <label for="monto" class="col-form-label">Cadete:</label>
                                    <?PHP
                                    ASIGNAR_CADETE();
                                    ?>
                                    </div>  
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" id="btnGuardar" class="btn btn-dark">Asignar cadete</button>
                                </div>
                            </form>    
                        </div>
                    </div>
