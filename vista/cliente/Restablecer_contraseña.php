                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">No se preocupe,  podra reestablecer con ingresar su Correo Electronico!</p>
                                    </div>
                                    <form class="user">
                                        ...
                                        <a href="login.html" class="btn btn-primary btn-user btn-block">Reestablecer contraseña </a>
                                    </form>
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="Registrar_empresa.php">Create an Account!</a>
                                    </div>
                                    <div class="text-center">
