...
$id_empleado_cadete=$_POST['Nro_Cadete'];
...
$estado_empleado=$conexion->query(" update  oferta_pedido set situacion_oferta=  'completado' where id_oferta='".$id_oferta."'");
$estado_empleado->execute();

// cambia el estado del cadete a ocupado
$estado_empleado=$conexion->query(" update  empleado set estado_disp_ocu = 'Disponible' 
Where id_empleados = '".$id_empleado_cadete."'");
$estado_empleado->execute();


//si se registra correctamente la empresa nos manda en la pantalla de inicio.
header('Location: ../../vista/empresa/pedido_encurso.php?exito=true');
