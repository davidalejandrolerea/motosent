...
if(isset($_SESSION['usuario'])){
    ...
    if($_SESSION['usuario']['RELA_TIPO_USUARIO']=="1" ){
        ...
        header('Location: vista/cliente/home.php');     
    }
}
...
<body class="bg-gradient-primary" onload="recargar()">
                 <div class="error">
                    <span >El nombre de usuario y/o contraseña ingresado es incorrecto</span>
                </div>
                <div class="agregado">
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <h1 class="h4 text-gray-900 mb-4">Empresas</h1>
                                        
                                        <h1 class="h4 text-gray-900 mb-4">¡Bienvenido!</h1>
                                    </div>
                                    <form class="user" action="#" method="POST" id="formLg">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="Registrar_empresa.php">¡Registrarse Como Empresa!</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="vista/cliente/index.php">¡Iniciar sesión como Cliente!</a>
                                    </div>

                                    <div class="text-center">
                                         <a class="small" href="vista/cliente/registrar_cliente.php">¡Registrarse Como Cliente!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
